package com.bxm.agent;

import java.lang.instrument.ClassFileTransformer;
import java.lang.instrument.IllegalClassFormatException;
import java.security.ProtectionDomain;

import com.bxm.probe.Probes;
...
public class AgentmainTimeTransformer implements ClassFileTransformer {
	...
	public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined,
		...
		try {
			...
			cm.insertBefore(String.format("com.bxm.probe.Probes.onBefore(%s);", id));
			cm.insertAfter(String.format("com.bxm.probe.Probes.onSuccess(%s);", id));
			datas = cc.toBytecode();
